                        ...
                        <div class="highlight-list">
                            ...
                            <div class="card card-sm highlight-card">
                                ...
                                <div class="wrapper">
                                    ...
                                    <p class="title-1">${humidity / 1000}<sub>km</sub></p>
                                </div>
                            </div>
                            <div class="card card-sm highlight-card">
            ...
            fetchData(url.forecast(lat, lon), function (forecast) {
                ...
                for (const [index, data] of forecastList.entries()) {
                    ...
                    windLi.innerHTML = `
                         <div class="card card-sm slider-card">
                            <p class="body-3">${module.getHours(dateTimeUnix, timezone)}</p>
                            <img src="./assets/images/weather_icons/direction.png" width="48" height="48" loading="lazy" alt="direction" style="transform: rotate(${windDirection - 180}deg)" class="weather-icon" title="">
